...
var ChineseNameGenerator = {
  ...
  "段干", "百里", "东郭", "南门", "呼延", "羊舌", "梁丘", "左丘", "东门", "西门", "南宫"],
    ...
    GetSurname:function()
    {
        var index = Utility.RandomUtility.Random(0, this.surname.length - 1);
    ...
    GetName3:function()
    {
        var _lastName = "震南洛栩嘉光琛潇闻鹏宇斌威汉火科技梦琪忆柳之召腾飞慕青问兰尔岚元香初夏沛菡傲珊曼文乐菱痴珊恨玉惜香寒新柔语蓉海安夜蓉涵柏水桃醉蓝春语琴从彤" +
        ...
        if (Utility.RandomUtility.Random(1, 2) == 1)
        {
            return "" + _lastName[Utility.RandomUtility.Random(0, _lastName.length - 1)] + _lastName[Utility.RandomUtility.Random(0, _lastName.length - 1)];
        }
        else
        {
            return "" + _lastName[Utility.RandomUtility.Random(0, _lastName.length - 1)];
        }
    },
    ...
    GetName:function()
    {
        ...
        assert(typeof(surname) != "undefined", "surname is undefined")
        var name = this.GetName3();
        assert(typeof(name) != "undefined", "name is undefined")
        return surname + name;
    },
}
